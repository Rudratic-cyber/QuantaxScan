...
export const BUDGETS = {
  ...
  /**
   * D7's certificate-transparency query. Tighter than `tls` for a reason that
...
const ROUTE_BUDGETS: ReadonlyArray<{
  ...
  // D7. Egress to a free public service that rations its own callers, fanning
  ...
  // The D7 → B3 handoff opens the same sockets `POST /projects/:id/tls` does,
