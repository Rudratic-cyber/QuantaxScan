...
export type RegulatorSubmissionExceptionsWaiversItemAttribution =
  (typeof RegulatorSubmissionExceptionsWaiversItemAttribution)[keyof typeof RegulatorSubmissionExceptionsWaiversItemAttribution];

export const RegulatorSubmissionExceptionsWaiversItemAttribution = {
  authenticated: "authenticated",
  asserted: "asserted",
} as const;

export type RegulatorSubmissionExceptionsWaiversItem = {
  fingerprint: string;
  algorithm: string;
  location: string;
  surface: string;
  ...
  signedOffBy: string;
  attribution: RegulatorSubmissionExceptionsWaiversItemAttribution;
  signedOffAt: string;
  expiresAt: string;
  daysRemaining: number;
};

export type RegulatorSubmissionExceptionsStatusWaivedWithoutRegisterEntryItem =
  {
    fingerprint: string;
    algorithm: string;
    location: string;
...
export type RegulatorSubmissionExceptions = {
  ...
  waivers: RegulatorSubmissionExceptionsWaiversItem[];
  ...
  statusWaivedWithoutRegisterEntry: RegulatorSubmissionExceptionsStatusWaivedWithoutRegisterEntryItem[];
