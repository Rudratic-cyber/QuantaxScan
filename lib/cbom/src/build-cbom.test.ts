...
const FIXTURE: CbomInput = {
  ...
  cryptoAssets: [
    ...
    { fingerprint: "111", surface: "source", algorithm: "ECDH", keySize: null, location: "project:2:x.go", status: "active", containedIn: "project:2" },
    ...
    { fingerprint: "999", surface: "tls", algorithm: "ECDH", keySize: null, location: "api.example.com:443", status: "active" },
