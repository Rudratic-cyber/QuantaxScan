...
each in three representations, and `tests/e2e/21-report-packs.spec.ts` asserts a real `%PDF-`
...
- ✅ Board pack PDF generates end-to-end from real inventory data — E1 shipped 2026-08-16;
  `tests/e2e/21-report-packs.spec.ts` seeds assets through a real scan, fetches
