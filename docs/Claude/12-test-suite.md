...
| **Real-Stack E2E Suite** | Playwright | `tests/e2e/*.spec.ts` (sixteen files) | Real PostgreSQL 16 container + built API server + Vite dev server, all on ports the run owns |
